    ...
    public sealed class Lattice : MonoBehaviour
    {
        ...
        void ResetMesh(NativeArray<Vertex> vertexArray)
        {
            ...
            _mesh.SetVertexBufferParams(
                ...
                new VertexAttributeDescriptor
                    (VertexAttribute.TexCoord0, VertexAttributeFormat.UNorm8, 4)
            );
        ...
        struct VertexConstructionJob : IJobParallelFor
        {
            ...
            public void Execute(int i)
            {
                ...
                output[i * 3 + 0] = new Vertex { position = V1, normal = N, texCoord = UNorm8x4._100 };
                output[i * 3 + 1] = new Vertex { position = V2, normal = N, texCoord = UNorm8x4._010 };
                output[i * 3 + 2] = new Vertex { position = V3, normal = N, texCoord = UNorm8x4._001 };
            }
        }
